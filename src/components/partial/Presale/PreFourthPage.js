...
<input type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder=""/>
</div>
</form>
     </div>
...
<input type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder="https://youtu.be/ahobeirZzp.."/>
</div>
</form>
    ...
    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
     ...
     <form>
<div className="form-group">
<label for="exampleInputEmail1">coinHunt.cc<span style={{color:"red"}}>*</span></label>
<input type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder="Ex :"/>
</div>
</form>
     </div>
...
<input type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder="Ex :"/>
    ...
    <div className="col-12 col-md-6 col-lg-6 col-xl-6">
     ...
     <form>
<div className="form-group">
<label for="exampleInputEmail1">Reddit<span style={{color:"red"}}>*</span></label>
<input type="text"  className="form-control preinput" id="exampleInputEmail1"  placeholder="Ex :"/>
</div>
</form>
     </div>
     ...
     <form>
<div className="form-group">
<label for="exampleInputEmail1">Medium <span style={{color:"red"}}>*</span></label>
<input type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder="Ex :"/>
</div>
</form>
...
<textarea style={{height:"150px"}} type="text" className="form-control preinput" id="exampleInputEmail1"  placeholder="Ex :"></textarea>
</div>
</form>
